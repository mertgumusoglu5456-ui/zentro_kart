  ...
  return (
    <div className={styles.scene}>
      ...
      <div className={styles.card}>
        ...
        {/* ── İletişim linkleri ── */}
        <nav className={styles.links} aria-label="İletişim bağlantıları">
          {/* Telefon */}
          ...
          {/* Adres — Maps linki varsa aktif, yoksa pasif */}
          <button
            className={`${styles.linkRow} ${!mapActive ? styles.linkRowDisabled : ''}`}
            onClick={mapActive ? handleMap : undefined}
            aria-label="Adres"
        ...
        <div className={styles.socials}>
          <button
            ...
            aria-label="WhatsApp'ta mesaj gönder"
          >
            <span className={styles.socialIcon}><IconWhatsApp /></span>
            <span>WhatsApp</span>
          </button>
          ...
          <button
            ...
            aria-label="Instagram profiline git"
          >
            <span className={styles.socialIcon}><IconInstagram /></span>
            <span>Instagram</span>
          </button>
        </div>
